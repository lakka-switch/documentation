...
2. Run it - it will tell you that some files are missing, remember the folder in the dialog, it should look like one of these :
    * <wbr>/storage/emulated/0/Android/data/io.mrarm.switchlinuxlauncher.noimx/files/shofel2</wbr>
    * <wbr>/sdcard/Android/data/io.mrarm.switchlinuxlauncher.noimx/files/shofel2</wbr>
